    ...
    function csv2wp_support_page() {
        ...
        <div class="wrap">
            ...
            <div id="csv-importer">
                ...
                <h2><?php esc_html_e( 'Format', 'csv2wp' ); ?></h2>
                <p><?php _e( "The first column in your CSV <strong>must</strong> be either a post id or a user id, otherwise the importer doesn't know where to assign the value.", "csv2wp" ); ?></p>
                ...
                <p>
                    <?php esc_html_e( 'Find more info about the plugin on', 'csv2wp' ); ?>
                    <a href="https://github.com/Beee4life/csv-to-wp/">GitHub</a>.
                </p>
