    ...
    function csv2wp_support_page() {
        ...
        <div class="wrap csv2wp">
            ...
            <div class="">
                ...
                <p><?php echo sprintf( __( 'If you know about this plugin, you probably know me and know where to reach me. If not, please report it on GitHub in the <a href="%s">issues section</a>.', 'csv-to-wp' ), esc_url( 'https://github.com/Beee4life/csv-to-wp/issues' ) ); ?></p>
                <p>
